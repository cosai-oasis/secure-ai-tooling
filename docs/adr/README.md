...
| [030](030-agentic-component-model.md) | Agentic component model — model-access boundary, enforcement-point individuation, and the external tools tier | Draft | 2026-07-29 |
