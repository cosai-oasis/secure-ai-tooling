...
graph LR
   %%{init: {'flowchart': {'nodeSpacing': 30, 'rankSpacing': 40, 'padding': 5, 'wrappingWidth': 250}}}%%
    ...
    riskModelSourceTampering --> controlModelRegistryIntegrity
    ...
    riskModelDeploymentTampering --> controlModelRegistryIntegrity
    ...
    riskInsecureIntegratedComponent --> controlModelRegistryIntegrity
    ...
    riskEvaluationBenchmarkManipulation --> controlModelRegistryIntegrity
    ...
    linkStyle 1,5,9,13,17,21,25,29,33,37,41,45,49,53,57,61,65,69,73,77,81,85,89,93,97,101,105,109,113,117,121,125,129,133 stroke:#b66871,stroke-width:2px,stroke-dasharray: 8 4
    linkStyle 2,6,10,14,18,22,26,30,34,38,42,46,50,54,58,62,66,70,74,78,82,86,90,94,98,102,106,110,114,118,122,126,130 stroke:#b66871,stroke-width:2px,stroke-dasharray: 10 2
    linkStyle 3,7,11,15,19,23,27,31,35,39,43,47,51,55,59,63,67,71,75,79,83,87,91,95,99,103,107,111,115,119,123,127,131 stroke:#1c0d0f,stroke-width:2px,stroke-dasharray: 12 5
